...
public class addBleUserModel {
    ...
    public init(tokenName: String, tokenPermission:TokenPermission, idenity: String) {
    ...
    private func getCommand()-> [UInt8] {
        ...
        let idValue = idenity.data(using: .utf8)?.bytes ?? []

        idValue.forEach{byteArray.append($0)}
